    ...
    return (
        ...
        <div class="dash">
            ...
            <thead className='table__thead'>
                ...
                <tbody>
                {isLoading ? <div className='loading' ><ReactLoading className='loading' type='bubbles' color='#2C3E50' height={60} width={60} /></div> : revSim.map(sim =>
                        {
                            return (
                         
                                <RowAllSim key={sim.id} sim={sim} />
                            )
                        })}
                        </tbody>
            </table>
